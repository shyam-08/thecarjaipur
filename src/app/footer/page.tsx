                                ...
                                <div className="col-md-4 col-sm-6 col-xs-12">
                                    <ul className="social-icons" style={{ display: 'flex', listStyle: 'none' }}>
                                        ...
                                        whileHover={{
                                            ...
                                            whileTap={{ scale: 0.9 }}><a className="instagram" href="https://www.instagram.com/codelixsolution/"></a><InstagramIcon color="secondary" /></motion.li>
                                        <motion.li 
                                        whileHover={{
                                            scale: 1.2,
                                            transition: { duration: 1 },
                                            ...
                                            whileTap={{ scale: 0.9 }}
                                        style={{ margin: '0 5px' }}><a className="facebook" href="https://hi-in.facebook.com/codelixsolution"><FacebookIcon />
                                        </a></motion.li>
                                        <motion.li
                                        whileHover={{
                                            scale: 1.2,
                                            ...
                                            whileTap={{ scale: 0.9 }}
                                        ><a className="twitter" href="https://twitter.com/codelixsolution"> </a><TwitterIcon color="primary" /></motion.li>
